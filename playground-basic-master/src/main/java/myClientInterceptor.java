...
public class myClientInterceptor implements IClientInterceptor {
	private static final org.slf4j.Logger ourLog = org.slf4j.LoggerFactory.getLogger(myClientInterceptor.class);
	 ...
	 */
	public myClientInterceptor(boolean theVerbose) {
		if (theVerbose) {
...
//			myLog.info("Client request: {}", theRequest);
	...
	public void interceptResponse(IHttpResponse theResponse) throws IOException {
		if (myLogResponseSummary) {
			...
			time =(int)theResponse.getRequestStopWatch().getMillis();
//			myLog.info("Client response: {}{}{}", message, respLocation, timing);
	...
	public void disableCache(IHttpRequest theRequest) {
